...
class TestWriteOff3(unittest.TestCase):
    def __test_write_off_v3(self,):
        ...
        positions = [
            {'quantity': 1, 'F2RegId': 'FB-000006632891398', 'marks': ['177400451244141018001CRVEMPFAI6UUPWCTXHVETPWSEU3LGOUYBLN33RX7BKTEDMJZHKHJC5LP4A7LBD2VCHPXPTAVLHWREQEOTND4RSZJZMV6CMAY6WPMKF3KK5Y5HFY3L2FZAWY6GN7DKVRBA']},
